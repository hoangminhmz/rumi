-- Seed Data: Populate preferences with options_config (SAFE VERSION)
-- Purpose: Add existing hardcoded options into database as JSON TEXT
-- Date: 2025-01-06
...
SELECT
  ...
  CASE
    ...
    ELSE SUBSTRING(options_config, 1, 50)
